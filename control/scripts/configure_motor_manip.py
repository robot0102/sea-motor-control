...
def configure_axis(axis):
    ...
    axis.encoder.config.calib_range = 0.5
    axis.encoder.config.idx_search_unidirectional = False

    # Motor Configuration
    axis.motor.config.pole_pairs = 21
    axis.motor.config.calibration_current = 10
    axis.motor.config.current_lim = 24.0
    axis.motor.config.resistance_calib_max_voltage = 10.0
    ...
    axis.controller.config.vel_gain = 0.001
