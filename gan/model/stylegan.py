...
class Generator(nn.Module):
    ...
    def forward(self, style, noise, const=None, step=0, alpha=-1, mixing_range=(-1, -1)):
        if const is None:
            out = noise[0]
        else:
            out = const
...
class StyledGenerator(nn.Module):
    ...
    def forward(
        ...
        return self.generator(styles, noise, condition, step, alpha, mixing_range=mixing_range)
